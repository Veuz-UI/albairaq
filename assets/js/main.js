...
$currentImg = $('#image-gallery img[src="' + $currentImgSrc + '"]'),
$nextImg = $($currentImg.closest(".image").next().find("img")),
$images = $("#image-gallery img");
$("#overlay img").attr("src", $nextImg.length > 0 ? $nextImg.attr("src") : $($images[0]).attr("src")).fadeIn(100);
...
var $currentImgSrc = $("#overlay img").attr("src"),
$currentImg = $('#image-gallery img[src="' + $currentImgSrc + '"]'),
$nextImg = $($currentImg.closest(".image").prev().find("img"));
